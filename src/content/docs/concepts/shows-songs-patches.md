...
This three-level model matches the real workflow: program your rig once at Show level, then design Songs and the Patches within them. Settings cascade down — see [Cascading Settings](/concepts/cascading-settings/).
...
See [Voice Tracking](/reliability/voice-tracking/) for how this avoids stuck notes between patches.
...
See [Patch Sequencing](/features/patch-sequencing/) for the full picture.
