...
All achievable by configuring the Layout tab. Layouts can be saved and **shared via the community hub** ([Community Sharing](/docs/pit/features/community-sharing/)).
