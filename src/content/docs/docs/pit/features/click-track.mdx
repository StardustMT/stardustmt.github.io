---
title: "Click Track"
description: "Per-Song click with configurable BPM, time signature, count-in. Standard musical-theatre / live-band tempo coordination."
---
...
<Badge text="📋 Planned · v0.8.0 engine, v0.12.0 editor" variant="note" />
