...
description: "Free hub for sharing device profiles, UI layouts, color themes, effect presets, patch presets — anything users want to give away."
---
...
<Badge text="💭 v1.x bridge" variant="tip" />
