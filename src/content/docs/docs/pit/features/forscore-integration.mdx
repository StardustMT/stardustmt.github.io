...
description: "Send MIDI commands from Stardust to forScore (iOS sheet-music app) for automatic page turns synced to Patch changes."
---
...
<Badge text="📋 Planned · v0.8.0" variant="note" />
