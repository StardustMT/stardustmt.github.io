...
The same network sync code underpins [Multi-keyboardist Sync](/docs/pit/features/multi-keyboardist-sync/) — Keys 1 advances and Keys 2 follows. Different application of the same mechanism.
