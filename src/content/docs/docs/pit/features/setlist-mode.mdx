---
title: "Setlist Mode"
description: "Walk through the show in order. Auto-advance or jump freely. Always know what's next."
---
...
<Badge text="✅ Shipped · v0.3.0 · refinements v0.9.0–v0.11.0" variant="success" />
