---
title: "Transpose"
description: "Pitch shift a Song up or down in semitones. Essential for night-to-night vocal-health adjustments."
---
...
<Badge text="✅ Shipped · v0.5.0 · UI v0.8.0" variant="success" />
