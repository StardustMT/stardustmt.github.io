...
Configure in the [Audio I/O](/features/audio-io/) panel.
...
Assign a footswitch (via [MIDI Learn](/features/midi-learn/)) as tap-tempo:
...
- [Audio I/O](/features/audio-io/)
- [MIDI Learn](/features/midi-learn/) (tap-tempo assignment)
- [Cue System](/features/cue-system/) (bar/beat cues — v0.5+)
