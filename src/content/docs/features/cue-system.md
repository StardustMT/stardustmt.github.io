...
Already mentioned in [MIDI Learn](/features/midi-learn/) and [Device Profiles](/features/device-profiles/) — for footswitch cues:
...
See [Cascading Settings](/concepts/cascading-settings/).
...
- [Click Track](/features/click-track/) (for timed/bar cues)
