...
Sampler-created sounds can be exported as `.sfz` + sample files and shared via [Community Sharing](/features/community-sharing/) — paid or free. Other users can install the sound bundle and it appears in their Sampler library.
...
- [Plugin Hosting](/features/plugin-hosting/) (sampler is a built-in plugin in the VST chain)
