...
The network sync underpinning multi-keyboardist sync is the same code used for [Hot-spare Rig](/features/hot-spare-rig/). Both are different applications of the same broadcast-state pattern.
...
- [Hot-spare Rig](/features/hot-spare-rig/) (same protocol)
- [Cue System](/features/cue-system/)
- [Mobile Companion](/features/mobile-companion/) (similar network code reuse)
