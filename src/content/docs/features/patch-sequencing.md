...
This is the core play experience of Stardust. See [Shows, Songs, and Patches](/concepts/shows-songs-patches/) for the concept.
...
See [Voice Tracking](/reliability/voice-tracking/).
...
- [MIDI Learn](/features/midi-learn/) (footswitch mapping)
- [Voice Tracking](/reliability/voice-tracking/)
